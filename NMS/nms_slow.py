...
images = [
    ("images/audrey.jpg", np.round(np.array([    # 180 256, 377
        (12, 84, 140, 212),
        (24, 84, 152, 212),
        (36, 84, 164, 212),
        (12, 96, 140, 224),
        (24, 96, 152, 224),
        (24, 108, 152, 236)], dtype='float32')*256./180.)),
    ("images/bksomels.jpg", np.round(np.array([
        (114, 60, 178, 124),
        (120, 60, 184, 124),
        (114, 66, 178, 130)], dtype='float32')*256./180.))]
